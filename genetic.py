...
def get_improvement_p(new_child, first_parent, generate_parent, maxAge, poolSize, maxSeconds, elit_size, elitism_rate,
...
def optimize(first_molecule:Molecule, fitness_param:str, strategies, max_age:int, pool_size:int, max_seconds:float, 
    ...
    def get_child(candidates, parent_index, queue:mp.Queue=None, child_index:int=None): # dar um jeito de usar bisect ao inves de deepcopy
        while True:
            try:

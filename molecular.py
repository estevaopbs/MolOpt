...
class Molecule:
    ...
    def __init__(self, basis: str, geometry: List[List[str]], settings: List[str], parameters: dict=dict(), 
        rand_range: Union[float, int]=None, label: str = None, output: str = None, output_values: dict = dict()):
        ...
        :param rand_range: Max value of generated distances while mutating, defaults to None
        :type rand_range: Union[float, int], optional
    ...
    def get_value(self, wanted: List[str], document: str = None, directory: str = 'data', keep_output: bool = False, 
        ...
        :param directory: Directory adress where the input and the output will be relative to __main__, defaults to 
            'data'
        :type directory: str, optional
        :param keep_output: If its True, the output will be kept and it's name will be put in [self.output], else it 
            will be deleted after be read. defaults to False
    ...
    def optg(self, wanted: List[str], directory: str = 'data', nthreads: int = 1, keep_output= False):
        ...
        :param nthreads: Number of threads useds in Molpro calculation, defaults to 1
        :type nthreads: int, optional
        :param keep_output: If its True, the output will be kept, else it will be deleted after be read. 
            defaults to False
        :type keep_output: bool, optional
    ...
    def mutate_distances(self, times: int = 1):
        """Provokes a mutation in some random distance parameter

        Selects a random distance parameter from the geometry and assign it a random value between 0 and 
    ...
    def mutate_angles(self, times: int = 1):
    ...
    @staticmethod
    def load(file: str, rand_range: Union[float, int] = None, label: str = None, output: str = None, 
...
def mutate_distances(molecule: Molecule, times: int = 1, label: str = None) -> Molecule:
    """Returns a molecule's copy with some random angle parameter randomized between 0 and [molecule.rand_range]
...
def random_molecule(molecular_formula: str, basis: str, settings: List[str], rand_range: Union[float, int], 
    label: str = None, dist_unit: str = 'ang') -> Molecule:
    """Creates molecule with a entirely random geometry given the molecular formula

    Creates a geometry with all distances parameters randomized between 0 and [rand_range] and all angles randomized 
    between 0 and 360 given the molecular formula which is a string containing the elements followed by it's amount like
    'H2O', 'C6H12O6', 'Al10'... It doesn't support parenthesys and is invariant to the order of elements. What matters
    in [molecular_formula] is what number follows what element
    ...
    :type settings: List[str]
    :param rand_range: Max value of generated distances while mutating, defaults to None
    :type rand_range: Union[float, int]
...
def randomize(molecule: Molecule, label: str = None) -> Molecule:
    ...
    Creates a molecule's copy and replace all distance parameters with random values between 0 and [molecule.rand_range]

...
class Molecule:
    ...
    def __init__(self, basis: str, geometry: list[list[str]], settings: list[str], parameters: dict = dict(), 
        rand_range: tuple[int | float, int | float] = None, label: str = None, output: str = None, 
        output_values: dict = dict(), was_optg: bool = False) -> None:
        ...
        :type rand_range: tuple[int | float, int | float], optional
    ...
    @staticmethod
    def load(file: str, rand_range: tuple[int | float, int | float] = None, label: str = None, output: str = None, 
...
def random_molecule(molecular_formula: str, basis: str, settings: list[str], 
    rand_range: tuple[int | float, int | float], label: str = None, dist_unit: str = 'ang') -> Molecule:
